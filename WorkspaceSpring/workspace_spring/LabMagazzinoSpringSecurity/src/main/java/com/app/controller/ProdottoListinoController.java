...
public class ProdottoListinoController {
	 ...
	 * @return
	 */
	@RequestMapping(value="/admin/aggiungiListini", method=RequestMethod.GET)
	 ...
	 * @return
	 */
	@RequestMapping(value="/admin/aggiungiListini", method=RequestMethod.POST)
	...
	@RequestMapping(value="/admin/visualizzaSingoloListino", method=RequestMethod.GET)
	public String visualizzaSingoloListinoAdmin(HttpServletRequest request, ModelMap model) {
		request.setAttribute("prodottiListino", ld.returnListinoById(Integer.parseInt(request.getParameter("Id"))).getProdotto());
		model.addAttribute("id", new Id());
		return "admin/singoloListino";
	}
	 ...
	 * @return
	 */
	@RequestMapping(value="/admin/eliminaSingoloProdotto", method=RequestMethod.POST)
