...
public class ProdottoController {
	 ...
	 * @return
	 */
	@RequestMapping(value="/inserimentoProdotti", method=RequestMethod.GET)
	 ...
	 * @return
	 */
	@RequestMapping(value="/modificaProdotti", method=RequestMethod.GET)
	 ...
	 * @return
	 */
	@RequestMapping(value="/eliminaProdotti", method=RequestMethod.GET)
	public String eliminaProdottoGet(HttpServletRequest request, ModelMap model) {
		Prodotto p=pd.returnProdottoById(Integer.parseInt(request.getParameter("id")));
		model.addAttribute("categoria", cd.visualizza());
		model.addAttribute("prodotto", p);
		return "eliminaProdotti";
	}
	 ...
	 * @return
	 */
	@RequestMapping(value="/inserimentoProdotti", method=RequestMethod.POST)
	 ...
	 * @return
	 */
	@RequestMapping(value="/modificaProdotti", method=RequestMethod.POST)
	 ...
	 * @return
	 */
	@RequestMapping(value="/eliminaProdotti", method=RequestMethod.POST)
